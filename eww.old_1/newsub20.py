...
def update_bt_scan_results(all_devices, stderr):
    ...
    for dev in all_devices:
        status_icon = "🟢" if dev['connected'] else "🌟" if dev['trusted'] else "🔵" if dev['paired'] else "⚪"
...
tk.Button(bt_button_frame, text="Trust Device", command=trust_bt_device, bg="#440044", fg="white").pack(side="left", padx=5) 
